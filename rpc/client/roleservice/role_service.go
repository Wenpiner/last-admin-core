...
// 重置超级管理员API权限
func (m *defaultRoleService) ResetSuperApi(ctx context.Context, in *ID32Request, opts ...grpc.CallOption) (*BaseResponse, error) {
	client := core.NewRoleServiceClient(m.cli.Conn())
	return client.ResetSuperApi(ctx, in, opts...)
}
