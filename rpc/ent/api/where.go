...
func NameIsNil() predicate.API {
	return predicate.API(sql.FieldIsNull(FieldName))
}

// NameNotNil applies the NotNil predicate on the "name" field.
func NameNotNil() predicate.API {
	return predicate.API(sql.FieldNotNull(FieldName))
}
