...
func (_q *TokenQuery) FirstID(ctx context.Context) (id uint32, err error) {
	var ids []uint32
...
func (_q *TokenQuery) FirstIDX(ctx context.Context) uint32 {
...
func (_q *TokenQuery) OnlyID(ctx context.Context) (id uint32, err error) {
	var ids []uint32
...
func (_q *TokenQuery) OnlyIDX(ctx context.Context) uint32 {
...
func (_q *TokenQuery) IDs(ctx context.Context) (ids []uint32, err error) {
...
func (_q *TokenQuery) IDsX(ctx context.Context) []uint32 {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *TokenQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(token.Table, token.Columns, sqlgraph.NewFieldSpec(token.FieldID, field.TypeUint32))
	_spec.From = _q.sql
