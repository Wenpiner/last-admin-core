...
func (_q *OauthProviderQuery) FirstID(ctx context.Context) (id uint32, err error) {
	var ids []uint32
...
func (_q *OauthProviderQuery) FirstIDX(ctx context.Context) uint32 {
...
func (_q *OauthProviderQuery) OnlyID(ctx context.Context) (id uint32, err error) {
	var ids []uint32
...
func (_q *OauthProviderQuery) OnlyIDX(ctx context.Context) uint32 {
...
func (_q *OauthProviderQuery) IDs(ctx context.Context) (ids []uint32, err error) {
...
func (_q *OauthProviderQuery) IDsX(ctx context.Context) []uint32 {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *OauthProviderQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(oauthprovider.Table, oauthprovider.Columns, sqlgraph.NewFieldSpec(oauthprovider.FieldID, field.TypeUint32))
	_spec.From = _q.sql
