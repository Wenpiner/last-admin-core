...
func (_q *DictItemQuery) QueryDictType() *DictTypeQuery {
...
func (_q *DictItemQuery) WithDictType(opts ...func(*DictTypeQuery)) *DictItemQuery {
	query := (&DictTypeClient{config: _q.config}).Query()
...
func (_q *DictItemQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*DictItem, error) {
	...
	if query := _q.withDictType; query != nil {
		if err := _q.loadDictType(ctx, query, nodes, nil,
			func(n *DictItem, e *DictType) { n.Edges.DictType = e }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *DictItemQuery) loadDictType(ctx context.Context, query *DictTypeQuery, nodes []*DictItem, init func(*DictItem), assign func(*DictItem, *DictType)) error {
...
func (_q *DictItemQuery) querySpec() *sqlgraph.QuerySpec {
	...
	if fields := _q.ctx.Fields; len(fields) > 0 {
		...
		if _q.withDictType != nil {
			_spec.Node.AddColumnOnce(dictitem.FieldDictTypeID)
		}
	}
