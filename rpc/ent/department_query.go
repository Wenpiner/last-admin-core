...
func (_q *DepartmentQuery) FirstID(ctx context.Context) (id uint32, err error) {
	var ids []uint32
...
func (_q *DepartmentQuery) FirstIDX(ctx context.Context) uint32 {
...
func (_q *DepartmentQuery) OnlyID(ctx context.Context) (id uint32, err error) {
	var ids []uint32
...
func (_q *DepartmentQuery) OnlyIDX(ctx context.Context) uint32 {
...
func (_q *DepartmentQuery) IDs(ctx context.Context) (ids []uint32, err error) {
...
func (_q *DepartmentQuery) IDsX(ctx context.Context) []uint32 {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *DepartmentQuery) loadParent(ctx context.Context, query *DepartmentQuery, nodes []*Department, init func(*Department), assign func(*Department, *Department)) error {
	...
	nodeids := make(map[uint32][]*Department)
	for i := range nodes {
...
func (_q *DepartmentQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(department.Table, department.Columns, sqlgraph.NewFieldSpec(department.FieldID, field.TypeUint32))
	_spec.From = _q.sql
