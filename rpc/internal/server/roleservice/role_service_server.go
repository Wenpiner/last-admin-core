...
// 重置超级管理员API权限
func (s *RoleServiceServer) ResetSuperApi(ctx context.Context, in *core.ID32Request) (*core.BaseResponse, error) {
	l := roleservicelogic.NewResetSuperApiLogic(ctx, s.svcCtx)
	return l.ResetSuperApi(in)
}
